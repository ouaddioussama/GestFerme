...
public class Achat {
	...
	public Achat(Integer id, Fournisseur fournisseur, Produit produit, Employee responsable, Employee user_logged,
			Integer ref_bon_achat, Unite unite, double prix_unitaire, double quantite, double montant_global,
			String designation_achat, Date dateOperation, Date dateAchat, Types_Reglement mode_paiement,
			Date dateDePaiement, String ref_reglement) {
		super();
		this.id = id;
	...
	public Date getDateAchat() throws ParseException {
		return dateAchat;
	}
